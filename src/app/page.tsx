...
const Main = () => {
  ...
  return (
    <>
      {/* Main Content */}
      <main id="container" className="bg-[url('/mnse_1.png')] bg-cover bg-center bg-no-repeat backdrop-blur grid grid-cols-12 grid-rows-7 grid-flow-row items-center justify-center h-screen">
